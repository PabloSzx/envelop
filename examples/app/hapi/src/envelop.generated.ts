...
import type { EnvelopContext } from '@pablosz/envelop-app/hapi';
...
) => Promise<import('@pablosz/envelop-app/hapi').DeepPartial<TResult>> | import('@pablosz/envelop-app/hapi').DeepPartial<TResult>;
