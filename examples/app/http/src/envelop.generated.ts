...
export type ResolversTypes = {
  ...
  String: ResolverTypeWrapper<import('@envelop/app/http').DeepPartial<Scalars['String']>>;
  Subscription: ResolverTypeWrapper<{}>;
  DateTime: ResolverTypeWrapper<import('@envelop/app/http').DeepPartial<Scalars['DateTime']>>;
  Boolean: ResolverTypeWrapper<import('@envelop/app/http').DeepPartial<Scalars['Boolean']>>;
};

/** Mapping between all available schema types and the resolvers parents */
export type ResolversParentTypes = {
  Query: {};
  String: import('@envelop/app/http').DeepPartial<Scalars['String']>;
  Subscription: {};
  DateTime: import('@envelop/app/http').DeepPartial<Scalars['DateTime']>;
  Boolean: import('@envelop/app/http').DeepPartial<Scalars['Boolean']>;
};
