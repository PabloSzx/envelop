...
import type { EnvelopContext } from '@pablosz/envelop-app/http';
...
) => Promise<import('@pablosz/envelop-app/http').DeepPartial<TResult>> | import('@pablosz/envelop-app/http').DeepPartial<TResult>;
