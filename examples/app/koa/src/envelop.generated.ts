...
export type ResolversTypes = {
  ...
  String: ResolverTypeWrapper<import('@pablosz/envelop-app/koa').DeepPartial<Scalars['String']>>;
  Subscription: ResolverTypeWrapper<{}>;
  DateTime: ResolverTypeWrapper<import('@pablosz/envelop-app/koa').DeepPartial<Scalars['DateTime']>>;
  Boolean: ResolverTypeWrapper<import('@pablosz/envelop-app/koa').DeepPartial<Scalars['Boolean']>>;
  Int: ResolverTypeWrapper<import('@pablosz/envelop-app/koa').DeepPartial<Scalars['Int']>>;
};

/** Mapping between all available schema types and the resolvers parents */
export type ResolversParentTypes = {
  Query: {};
  String: import('@pablosz/envelop-app/koa').DeepPartial<Scalars['String']>;
  Subscription: {};
  DateTime: import('@pablosz/envelop-app/koa').DeepPartial<Scalars['DateTime']>;
  Boolean: import('@pablosz/envelop-app/koa').DeepPartial<Scalars['Boolean']>;
  Int: import('@pablosz/envelop-app/koa').DeepPartial<Scalars['Int']>;
};
